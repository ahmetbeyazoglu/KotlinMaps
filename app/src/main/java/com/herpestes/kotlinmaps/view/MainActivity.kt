...
import com.herpestes.kotlinmaps.adapter.PlaceAdapter
import com.herpestes.kotlinmaps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        menuInflater.inflate(R.menu.place_menun,menu)
